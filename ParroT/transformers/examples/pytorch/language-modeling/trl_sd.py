...
def load_sd_related_model(args, reward_fn, prompt_fn):
    ...
    cfg.DTYPE = "float16"
    cfg.GLOVE_DIR = "/home/export/base/ycsc_chenkh/chenkh/online1/andongchen/vision_MT/mmt_image/RAG-MT/graph/VSG/glove/"
    cfg.MODEL.PRETRAINED_DETECTOR_CKPT = "/home/export/base/ycsc_chenkh/chenkh/online1/andongchen/vision_MT/mmt_image/RAG-MT/graph/VSG/checkpoint/"
    cfg.OUTPUT_DIR = "/home/export/base/ycsc_chenkh/chenkh/online1/andongchen/vision_MT/mmt_image/RAG-MT/graph/VSG/checkpoint/"
    cfg.DETECTED_SGG_DIR = "./trashbin"
    ...
    train_cfg = DDPOConfig(
        num_epochs = args.ddpo_num_epochs,
        logdir = args.ddpo_logging_dir,
        train_batch_size = args.ddpo_train_batch_size,
        sample_batch_size = args.ddpo_sample_batch_size,
        train_learning_rate = args.ddpo_train_learning_rate,
    )
    train_cfg.project_kwargs = {
        "logging_dir": args.ddpo_logging_dir,
        "automatic_checkpoint_naming": True,
        "total_limit": 5,
        "project_dir": args.ddpo_ckpt_dir
    }
    ...
    return pipe, sim_model, detect_model, trainer
...
def load_model(args, script_args=None):
    ...
    tokenizer = LlamaTokenizer.from_pretrained(args.dreamllm_model)
...
def reward_fn(VSG_model, sim_model, topk=30, DETECTED_SGG_DIR="./", cfg=None):
    ...
    def _fn(images, prompts, metadata):
        ...
        # Error handler: Not elegant and OK enough
        if predictions == None:
