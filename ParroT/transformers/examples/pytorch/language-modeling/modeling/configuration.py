...
from typing import Any, NewType, TypeAlias, Literal

from omegaconf import DictConfig, OmegaConf
from transformers import PreTrainedTokenizerBase
from transformers.configuration_utils import PretrainedConfig

from modeling.lazy import LazyCall as LazyCaller
...
class IMAGEConfig(PretrainedConfig):
    r"""
    ...
    def update_plugins(self, init_kwargs: ConfigAndInitKwargs):
        ...
        lazy_init = LazyCaller(cls)(**init_kwargs)
        lazy_init = OmegaConf.to_container(init_kwargs, resolve=True)
