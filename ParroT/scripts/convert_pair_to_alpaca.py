...
lang_instruction = {
    ...
    'en': {'de': "German", 'en': "English", 'ja': "Japanese", 'zh': "Chinese", 'fr': "French", 'hi': "Hindi", 'cs': "Czech"},
    'ja': {'de': "ドイツ語", 'en': "英語", 'ja': "日本語", 'zh': "中国語"},
    'zh': {'de': "德语", 'en': "英语", 'ja': "日语", 'zh': "中文"},
    'fr': {'de': "Allemand", 'en': "Anglais", 'ja': "japonaise", 'zh': "Chinois"},
}
...
def create_prompt(slines, tlines, ins_list, max_cxt):
    ...
    for i in range(len(slines)):
        ...
        p["input"] = slines[i].strip()
        p["output"] = tlines[i].strip()
        prompts.append(p)
    return prompts
